...
function runner.env_override(m)
  local live = runner.getenv("NPPESNPIREGISTRY_TEST_LIVE")
  local override = runner.getenv("NPPESNPIREGISTRY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("NPPESNPIREGISTRY_TEST_EXPLAIN")
