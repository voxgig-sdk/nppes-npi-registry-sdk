...
describe("SearchNpiDirect", function()
  it("should direct-list-search_npi", function()
    local setup = search_npi_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-search_npi", setup.live and "live" or "unit")
