...
Results: Successful response with provider data.
...
| --- | --- | --- | --- |
| SearchNpi | `list` | `GET /` | See reference |

## Connect to the API

- NPPES NPI Registry API Server: `https://npiregistry.cms.hhs.gov/api`
...
- `nppes-npi-registry_list`: List records for an entity. Supported entities: `search_npi`.
- `nppes-npi-registry_load`: Load one record for an entity. No active entity supports this operation.
