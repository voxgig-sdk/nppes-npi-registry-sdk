...
from nppesnpiregistry_sdk.core.helpers import get_ctx_prop, to_map
...
class NppesNpiRegistryContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NppesNpiRegistryControl()
        ...
        if isinstance(sp, NppesNpiRegistrySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NppesNpiRegistryResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NppesNpiRegistryResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NppesNpiRegistryOperation({})
    ...
    def make_error(self, code, msg):
        return NppesNpiRegistryError(code, msg, self)
