...
from nppesnpiregistry_sdk.nppesnpiregistry_types import (
    SearchNpi,
    SearchNpiListMatch,
)
...
class SearchNpiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return SearchNpiEntity(self._client, opts)
