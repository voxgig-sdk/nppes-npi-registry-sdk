...
from nppesnpiregistry_sdk.utility import register

# Load features
from nppesnpiregistry_sdk.feature.base_feature import NppesNpiRegistryBaseFeature
from nppesnpiregistry_sdk.features import _has_feature, _make_feature
...
class NppesNpiRegistrySDK:
    ...
    def get_utility(self):
        return NppesNpiRegistryUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NppesNpiRegistrySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def SearchNpi(self, data=None) -> "SearchNpiEntity":
        ...
        from nppesnpiregistry_sdk.entity.search_npi_entity import SearchNpiEntity
