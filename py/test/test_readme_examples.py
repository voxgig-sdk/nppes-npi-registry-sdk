# NppesNpiRegistry SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NppesNpiRegistrySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NppesNpiRegistrySDK(...) and NppesNpiRegistrySDK.test(...) become
#      NppesNpiRegistrySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nppesnpiregistry_sdk"
_SDK_CLASS = "NppesNpiRegistrySDK"
