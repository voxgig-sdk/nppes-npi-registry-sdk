...
function envOverride(m) {
    if ('TRUE' === process.env.NPPES_NPI_REGISTRY_TEST_LIVE ||
        'TRUE' === process.env.NPPES_NPI_REGISTRY_TEST_OVERRIDE) {
    ...
    m.NPPES_NPI_REGISTRY_TEST_EXPLAIN = process.env.NPPES_NPI_REGISTRY_TEST_EXPLAIN || m.NPPES_NPI_REGISTRY_TEST_EXPLAIN;
    return m;
}
