...
(0, node_test_1.describe)('SearchNpiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NppesNpiRegistrySDK({
    ...
    (0, node_test_1.test)('direct-list-search_npi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-search_npi', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NPPES_NPI_REGISTRY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NppesNpiRegistrySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NPPES_NPI_REGISTRY_TEST_SEARCH_NPI_ENTID'];
    ...
    const client = new __1.NppesNpiRegistrySDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SearchNpiDirect.test.js.map