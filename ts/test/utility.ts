...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.NPPESNPIREGISTRY_TEST_LIVE ||
    'TRUE' === process.env.NPPESNPIREGISTRY_TEST_OVERRIDE
  ) {
  ...
  m.NPPESNPIREGISTRY_TEST_EXPLAIN = process.env.NPPESNPIREGISTRY_TEST_EXPLAIN || m.NPPESNPIREGISTRY_TEST_EXPLAIN
