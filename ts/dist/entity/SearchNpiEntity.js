...
class SearchNpiEntity extends NppesNpiRegistryEntityBase_1.NppesNpiRegistryEntityBase {
    constructor(client, entopts) {
        ...
        this.name = 'search_npi';
        this.name_ = 'search_npi';
        this.Name = 'SearchNpi';
    }
    make() {
        return new SearchNpiEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<SearchNpi[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.SearchNpiEntity = SearchNpiEntity;
//# sourceMappingURL=SearchNpiEntity.js.map