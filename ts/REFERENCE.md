# NppesNpiRegistry TypeScript SDK Reference

Complete API reference for the NppesNpiRegistry TypeScript SDK.
...
```ts
new NppesNpiRegistrySDK(options?: object)
```
...
#### `NppesNpiRegistrySDK.test(testopts?, sdkopts?)`
...
**Returns:** `NppesNpiRegistrySDK` instance in test mode.


### Instance Methods

#### `SearchNpi(data?: object)`

Create a new `SearchNpi` entity instance.
...
**Returns:** `SearchNpiEntity` instance.
...
Alias for `NppesNpiRegistrySDK.test()`.
...
| `basic` | `Record<string, any>` | No | Basic provider information |
...
Return the parent `NppesNpiRegistrySDK` instance.
