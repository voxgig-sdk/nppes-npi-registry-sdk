...
AQL-driven CLI and REPL for the NppesNpiRegistry SDK. Positional arguments are
...
```sh
go build -o nppes-npi-registry-cli ./...
```
...
./nppes-npi-registry-cli load 1 search_npi
./nppes-npi-registry-cli load '{id:1}' search_npi
