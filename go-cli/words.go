...
func registerSDKWords(r *eng.Registry, client *sdk.NppesNpiRegistrySDK) {
...
func runOp(client *sdk.NppesNpiRegistrySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
