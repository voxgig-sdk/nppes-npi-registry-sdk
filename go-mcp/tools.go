...
type Args struct {
	Entity string         `json:"entity" jsonschema:"search_npi"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NppesNpiRegistrySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nppes-npi-registry_list",
		Description: "List records from NppesNpiRegistry. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nppes-npi-registry_load",
		Description: "Load a single record from NppesNpiRegistry. " +
...
func runOp(client *sdk.NppesNpiRegistrySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NppesNpiRegistrySDK, name string) (sdk.NppesNpiRegistryEntity, error) {
	switch strings.ToLower(name) {
	case "search_npi":
		return client.SearchNpi(nil), nil
