// Command NppesNpiRegistry-mcp is an MCP server exposing the NppesNpiRegistry
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NppesNpiRegistry_list  — list records of an entity
//	NppesNpiRegistry_load  — load a single record of an entity
//
