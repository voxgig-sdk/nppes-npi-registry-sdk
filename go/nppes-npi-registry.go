...
import (
	...
	"github.com/voxgig-sdk/nppes-npi-registry-sdk/go/entity"
	"github.com/voxgig-sdk/nppes-npi-registry-sdk/go/feature"
	_ "github.com/voxgig-sdk/nppes-npi-registry-sdk/go/utility"
)
...
// instead of `sdk.NewNppesNpiRegistrySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *NppesNpiRegistrySDK  { return NewNppesNpiRegistrySDK(nil) }
func Test() *NppesNpiRegistrySDK { return TestSDK(nil, nil) }
