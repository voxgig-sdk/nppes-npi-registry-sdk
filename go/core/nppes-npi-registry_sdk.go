...
func (sdk *NppesNpiRegistrySDK) OptionsMap() map[string]any {
...
func (sdk *NppesNpiRegistrySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NppesNpiRegistrySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NppesNpiRegistrySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NppesNpiRegistrySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NppesNpiRegistrySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NppesNpiRegistrySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NppesNpiRegistrySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NppesNpiRegistrySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NppesNpiRegistrySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NppesNpiRegistrySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NppesNpiRegistrySDK {
	...
	sdk := NewNppesNpiRegistrySDK(sdkopts)
	sdk.Mode = "test"
