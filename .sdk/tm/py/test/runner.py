...
class NppesNpiRegistryTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NppesNpiRegistryTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NppesNpiRegistryTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NppesNpiRegistryTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
