...
// NppesNpiRegistry SDK utility type

class NppesNpiRegistryUtility
{
    ...
    public static function copy(NppesNpiRegistryUtility $src): NppesNpiRegistryUtility
    {
        $u = new NppesNpiRegistryUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
