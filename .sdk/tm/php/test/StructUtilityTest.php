...
// NppesNpiRegistry SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NppesNpiRegistryOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NppesNpiRegistryOmni::structfix($now, Struct::undef()))
                        !== json_encode(NppesNpiRegistryOmni::structfix($val, Struct::undef()))) {
