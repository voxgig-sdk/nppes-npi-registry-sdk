...
// NppesNpiRegistry SDK pipeline test
//
...
{
    private static function utility(): NppesNpiRegistryUtility
    {
        return new NppesNpiRegistryUtility();
    }
    ...
    private static function ctx(array $over = []): NppesNpiRegistryContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NppesNpiRegistryContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NppesNpiRegistryError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NppesNpiRegistryMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NppesNpiRegistryMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NppesNpiRegistryMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NppesNpiRegistrySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NppesNpiRegistryMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NppesNpiRegistryResponse([]),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        [, $err] = NppesNpiRegistryMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec([]),
            'response' => null,
            'result' => new NppesNpiRegistryResult([]),
        ]);
        [, $err] = NppesNpiRegistryMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec(['step' => 's']),
            'response' => new NppesNpiRegistryResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        [, $err] = NppesNpiRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec(['step' => 's']),
            'response' => new NppesNpiRegistryResponse(self::resp(200, ['v' => 1])),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        [, $err] = NppesNpiRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec(['step' => 's']),
            'response' => new NppesNpiRegistryResponse(self::resp(200, ['v' => 2])),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NppesNpiRegistryMakeResponse::call($ctx);
    ...
    {
        $preset = new NppesNpiRegistryResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec([]),
            'response' => new NppesNpiRegistryResponse([]),
            'result' => new NppesNpiRegistryResult([]),
        ...
        [$got, $err] = NppesNpiRegistryMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NppesNpiRegistryResult([])]);
        [, $err] = NppesNpiRegistryMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NppesNpiRegistrySpec([]), 'result' => null]);
        [, $err] = NppesNpiRegistryMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NppesNpiRegistrySpec(['step' => 's']),
            'result' => new NppesNpiRegistryResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NppesNpiRegistryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NppesNpiRegistrySpec(['step' => 's']),
            'result' => new NppesNpiRegistryResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NppesNpiRegistryOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NppesNpiRegistryMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NppesNpiRegistryResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NppesNpiRegistrySpec([]),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NppesNpiRegistryMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NppesNpiRegistryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NppesNpiRegistryError('boom', 'boom');
        $utility->fetcher = function (NppesNpiRegistryContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NppesNpiRegistrySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NppesNpiRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NppesNpiRegistryContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NppesNpiRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NppesNpiRegistryResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NppesNpiRegistryMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NppesNpiRegistryContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NppesNpiRegistrySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NppesNpiRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NppesNpiRegistryResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NppesNpiRegistrySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NppesNpiRegistryMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NppesNpiRegistryMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NppesNpiRegistryMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NppesNpiRegistryResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NppesNpiRegistryDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NppesNpiRegistryResult(['ok' => false])]);
        $this->expectException(NppesNpiRegistryError::class);
        NppesNpiRegistryDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NppesNpiRegistryResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NppesNpiRegistryMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NppesNpiRegistryMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NppesNpiRegistryBaseFeature();
        $b = new NppesNpiRegistryBaseFeature();
        NppesNpiRegistryFeatureAdd::call($ctx, $a);
        NppesNpiRegistryFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NppesNpiRegistryBaseFeature
    {
        $f = new NppesNpiRegistryBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NppesNpiRegistryFeatureAdd::call($ctx, self::named_feature('a'));
        NppesNpiRegistryFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        NppesNpiRegistryFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        NppesNpiRegistryFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        NppesNpiRegistryFeatureAdd::call($ctx, $replace);
        ...
        NppesNpiRegistryFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NppesNpiRegistryContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NppesNpiRegistrySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NppesNpiRegistryPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NppesNpiRegistryPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NppesNpiRegistryResponse(['headers' => null]),
            'result' => new NppesNpiRegistryResult([]),
        ]);
        NppesNpiRegistryResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NppesNpiRegistryResultBody::call($ctx);
