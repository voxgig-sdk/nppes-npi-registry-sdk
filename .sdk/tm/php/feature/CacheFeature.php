...
// NppesNpiRegistry SDK cache feature
...
class NppesNpiRegistryCacheFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _through(NppesNpiRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
