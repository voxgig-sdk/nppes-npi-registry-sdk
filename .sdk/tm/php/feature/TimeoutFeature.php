...
// NppesNpiRegistry SDK timeout feature
...
class NppesNpiRegistryTimeoutFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _with_timeout(NppesNpiRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NppesNpiRegistryContext $_ctx, float $ms): void
    {
        $client = $this->client;
