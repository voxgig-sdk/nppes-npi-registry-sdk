...
// NppesNpiRegistry SDK audit feature
...
class NppesNpiRegistryAuditFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _emit(NppesNpiRegistryContext $ctx, string $outcome): void
    {
