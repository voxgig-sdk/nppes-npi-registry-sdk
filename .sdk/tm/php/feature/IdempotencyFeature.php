...
// NppesNpiRegistry SDK idempotency feature
...
class NppesNpiRegistryIdempotencyFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _mutating(NppesNpiRegistryContext $ctx): bool
    {
