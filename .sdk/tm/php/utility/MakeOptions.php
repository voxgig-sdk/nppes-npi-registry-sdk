...
// NppesNpiRegistry SDK utility: make_options

class NppesNpiRegistryMakeOptions
{
    ...
    public static function call(NppesNpiRegistryContext $ctx): array
    {
        ...
        //
        // `NppesNpiRegistrySchema::optspec()` is built from the model:
        ...
        $optspec = NppesNpiRegistrySchema::optspec();
