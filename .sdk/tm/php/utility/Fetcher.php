...
// NppesNpiRegistry SDK utility: fetcher

class NppesNpiRegistryFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NppesNpiRegistrySDK/1.0)';
    ...
    public static function call(NppesNpiRegistryContext $ctx, string $fullurl, array $fetchdef): array
    {
