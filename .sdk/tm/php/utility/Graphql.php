...
// NppesNpiRegistry SDK utility: graphql
//
...
class NppesNpiRegistryGraphql
{
    ...
    // equivalent.
    public static function body(NppesNpiRegistryContext $ctx): mixed
    {
    ...
    public static function errors(NppesNpiRegistryContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
