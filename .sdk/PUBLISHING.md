...
|---|---|---|
| `ts/` | @voxgig-sdk/nppes-npi-registry-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nppes-npi-registry-sdk \
      --repository voxgig-sdk/nppes-npi-registry-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nppes-npi-registry-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nppes-npi-registry-sdk --id=<id>` removes it.
