# NppesNpiRegistry Ruby SDK Reference

Complete API reference for the NppesNpiRegistry Ruby SDK.
...
#### `NppesNpiRegistrySDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.SearchNpi.list(nil)
```
