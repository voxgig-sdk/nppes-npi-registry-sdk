...
#      offline in seeded test mode (NppesNpiRegistrySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "NppesNpiRegistry_sdk.rb")
  SDK_CLASS = "NppesNpiRegistrySDK"
