# NppesNpiRegistry PHP SDK Reference

Complete API reference for the NppesNpiRegistry PHP SDK.
...
#### `NppesNpiRegistrySDK::test($testopts = null, $sdkopts = null)`
