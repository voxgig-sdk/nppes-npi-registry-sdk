...
// NppesNpiRegistry SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NppesNpiRegistrySDK::test)
...
{
    private const SDK_CLASS = 'NppesNpiRegistrySDK';
    ...
    private const SDK_BASE = 'nppesnpiregistry_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../nppesnpiregistry_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
