...
// NppesNpiRegistry SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NppesNpiRegistryMakeRequest
{
    public static function call(NppesNpiRegistryContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NppesNpiRegistryResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NppesNpiRegistryResponse($fetched);
        } else {
