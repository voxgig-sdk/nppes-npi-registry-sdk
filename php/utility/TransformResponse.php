...
// NppesNpiRegistry SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NppesNpiRegistryTransformResponse
{
    public static function call(NppesNpiRegistryContext $ctx): mixed
    {
        ...
        $transform = NppesNpiRegistryHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
