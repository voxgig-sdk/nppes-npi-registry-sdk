...
// NppesNpiRegistry SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class NppesNpiRegistryParam
{
    public static function call(NppesNpiRegistryContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = NppesNpiRegistryHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
