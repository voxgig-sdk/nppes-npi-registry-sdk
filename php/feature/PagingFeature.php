...
// NppesNpiRegistry SDK paging feature
...
class NppesNpiRegistryPagingFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _is_list(NppesNpiRegistryContext $ctx): bool
    {
