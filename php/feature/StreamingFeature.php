...
// NppesNpiRegistry SDK streaming feature
...
class NppesNpiRegistryStreamingFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _iterate(NppesNpiRegistryResult $result): \Generator
    {
    ...
    private function _streamable(NppesNpiRegistryContext $ctx): bool
    {
