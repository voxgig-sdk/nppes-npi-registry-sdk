...
// NppesNpiRegistry SDK clienttrack feature
...
class NppesNpiRegistryClienttrackFeature extends NppesNpiRegistryBaseFeature
{
    ...
    public function PostConstruct(NppesNpiRegistryContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NppesNpiRegistry-SDK';
