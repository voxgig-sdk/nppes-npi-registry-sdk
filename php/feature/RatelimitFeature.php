...
// NppesNpiRegistry SDK ratelimit feature
...
class NppesNpiRegistryRatelimitFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _acquire(NppesNpiRegistryContext $ctx): void
    {
    ...
    private function _track(NppesNpiRegistryContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
