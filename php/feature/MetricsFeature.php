...
// NppesNpiRegistry SDK metrics feature
...
class NppesNpiRegistryMetricsFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _record(NppesNpiRegistryContext $ctx, bool $ok): void
    {
