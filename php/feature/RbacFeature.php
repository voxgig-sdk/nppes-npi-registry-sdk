...
// NppesNpiRegistry SDK rbac feature
...
class NppesNpiRegistryRbacFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _required(NppesNpiRegistryContext $ctx): ?string
    {
    ...
    private function _reject(NppesNpiRegistryContext $ctx, string $required): void
    {
    ...
    private function _track(NppesNpiRegistryContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
