...
// NppesNpiRegistry SDK proxy feature
...
class NppesNpiRegistryProxyFeature extends NppesNpiRegistryBaseFeature
{
    ...
    public function init(NppesNpiRegistryContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NppesNpiRegistryContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
