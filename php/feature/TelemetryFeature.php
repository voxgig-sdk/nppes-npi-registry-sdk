...
// NppesNpiRegistry SDK telemetry feature
...
class NppesNpiRegistryTelemetryFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _close(NppesNpiRegistryContext $ctx, bool $ok): void
    {
