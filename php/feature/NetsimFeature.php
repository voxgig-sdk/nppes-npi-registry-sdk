...
// NppesNpiRegistry SDK netsim feature
...
class NppesNpiRegistryNetsimFeature extends NppesNpiRegistryBaseFeature
{
    ...
    private function _simulate(NppesNpiRegistryContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NppesNpiRegistryContext $ctx, array $applied): void
    {
        $client = $this->client;
